...
$sql = "SELECT * FROM curso LEFT OUTER JOIN profesores ON curso.prof_id = profesores.prof_id";
...
<thead class="thead-dark">
      ...
      while ($row=$resultado->fetch_assoc()){
        ...
        "onclick="return confirm('¿Seguro que deseas eliminar este curso?')">Eliminar</td>
